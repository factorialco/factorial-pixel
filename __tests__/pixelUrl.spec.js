...
describe('pixelUrl', () => {
  ...
  describe('spanish and subdomain', () => {
    it('returns the data', () => {
      ...
      expect(pixelUrl(dom.window.document)).toEqual('https://staging.factorialhr.com/api/internal/pixel?mc=&referer=&language=es&landing_page=https://staging.factorialhr.es/blog')
    })
  })
})
